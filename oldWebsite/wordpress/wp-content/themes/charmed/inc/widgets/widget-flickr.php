...
class Bean_Flickr_Widget extends WP_Widget 
{
	...
	function __construct() {
		parent::__construct(
			'bean_flickr', // Base ID
			__( 'Flickr Photos', 'charmed' ), // Name
			array( 'description' => __( 'Add a Flickr feed widget.', 'charmed' ), ) // Args
		);
	}
	...
	function form( $instance ) 
	{
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e('Title / Intro:', 'charmed') ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'flickrID' )); ?>"><?php _e('Flickr ID:', 'charmed') ?> (<a target="_blank" href="http://idgettr.com/">idGettr</a>)</label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'type' )); ?>"><?php _e('Type:', 'charmed') ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'display' )); ?>"><?php _e('Display:', 'charmed') ?></label>
